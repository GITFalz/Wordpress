export default function CarteMenu({ name = null, description = null, entrees = null, plats = null, desserts = null, border = '#000000' }) {
    return (
        <div className="relative carte-menu flex flex-col items-center justify-center min-h-20 p-10 bg-gradient-to-bl from-black to-gray-700 shadow-lg rounded-lg text-white" style={{ borderWidth: '8px', borderColor: border,  borderStyle: 'solid', }}>
            ...
            {description && 
            <div className="bg-[rgba(255,255,255,0.05)] w-[600px] flex items-center justify-center p-3 mt-2 mb-2">
                <p>{description}</p>
            </div>}
            {entrees && 
            <>
