...
export default function EditCarte({ user, onClickClose, expandedSidebar, isXL }) {
    const [visibleList, setVisibleList] = useState("menu");
    const [expandedCategorieMenu, setExpandedCategorieMenu] = useState(false);
    ...
    const handleSetVisibleList = (section) => {
        ...
        window.location.hash = `edit/${section}`;
    };
    ...
    const handleHashChange = () => {
        ...
        const secondPart = hash.split('/')[1];
        setVisibleList(secondPart);
    };
    ...
    return (
        <>
            <div className={`${expandedSidebar && isXL ? 'pl-64' : 'pl-24' } ${expandedCategorieMenu ? '' : 'w-0'} fixed pt-24 inset-0 z-20 bg-white shadow-lg`} id="side-menu">
                <button className="p-4" onClick={() => setExpandedCategorieMenu(false)}>
                Close
                </button>
            </div>
            <section className="w-full flex items-start justify-center py-12 px-4">
                <div className="w-full max-w-5xl space-y-10 flex flex-col justify-center items-center">
                    <div className="md:text-4xl font-semibold z-10 px-0">Je remplis & personnalise ma carte
                        <div className=" lg:block hidden border-t-[15px] border-[#ffba00;] w-full mt-[-8px]"></div>
                    </div>
                    <div className=" w-full lg:flex hidden">
                        <div className="bg-white relative w-1/2 rounded-xl">
                            <div className="p-6">
                                <div className="flex items-center gap-2 mb-6">
                                    <img src="/src/assets/images/je-remplis-ma-carte.png" alt="Description" className="w-9 h-8" />
                                    <h2 className="text-lg font-semibold">
                                        Je remplis ma carte
                                    </h2>
                                </div>
                                <div className="grid grid-cols-1 gap-3">
                                    <button className="button-menus w-full flex items-center justify-between gap-3 px-4 py-3 rounded-xl transition active:bg-orange-400 bg-gray-100 hover:bg-orange-300 hover:text-white" onClick={() => handleSetVisibleList("menu")}>
                                    ...
                                    <button className="button-categories w-full flex items-center justify-between gap-3 px-4 py-3 rounded-xl transition active:bg-orange-400 bg-gray-100 hover:bg-orange-300 hover:text-white" onClick={() => handleSetVisibleList("categories")}>
                                        <div className="flex items-center gap-2">
                                    ...
                                    <button className="button-infos w-full flex items-center justify-between gap-3 px-4 py-3 rounded-xl transition active:bg-orange-400 bg-gray-100 hover:bg-orange-300 hover:text-white" onClick={() => handleSetVisibleList("infos")}>
                                        <div className="flex items-center gap-2">
                        ...
                        <div className="bg-white rounded-xl relative w-1/2">
                            <div className="p-6">
                                <div className="flex items-center gap-2 mb-6">
                                    <img src="/src/assets/images/je-personnalise-ma-carte.png" alt="Description" className="w-9 h-8" />
                                    <h2 className="text-lg font-semibold">
                                        Je personnalise ma carte
                                    </h2>
                                </div>
                                <div className="grid grid-cols-1 gap-3">
                                    <button className="w-full flex items-center justify-between gap-3 px-4 py-3 rounded-xl transition active:bg-orange-400 bg-gray-100 hover:bg-orange-300 hover:text-white" onClick={() => handleSetVisibleList("logo")}>
                                        <div className="flex items-center gap-2">
                                    ...
                                    <button className="w-full flex items-center justify-between gap-3 px-4 py-3 rounded-xl transition active:bg-orange-400 bg-gray-100 hover:bg-orange-300 hover:text-white" onClick={() => handleSetVisibleList("styles")}>
                                        <div className="flex items-center gap-2">
                                    ...
                                    <button className="w-full flex items-center justify-between gap-3 px-4 py-3 rounded-xl transition active:bg-orange-400 bg-gray-100 hover:bg-orange-300 hover:text-white" onClick={() => handleSetVisibleList("languages")}>
                                        <div className="flex items-center gap-2">
                    ...
                    <div className="lg:hidden border border-orange-500 p-2 flex text-orange-500 items-center gap-2 cursor-pointer rounded-xl hover:bg-orange-100 transition-colors" onClick={() => setExpandedCategorieMenu(!expandedCategorieMenu)}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path fill="currentColor" fill-rule="evenodd" d="M2.5 5a1.25 1.25 0 1 0 0-2.5a1.25 1.25 0 0 0 0 2.5m3.25-2a.75.75 0 0 0 0 1.5h8.5a.75.75 0 0 0 0-1.5zm0 8.5a.75.75 0 0 0 0 1.5h8.5a.75.75 0 0 0 0-1.5zM5 8a.75.75 0 0 1 .75-.75h8.5a.75.75 0 0 1 0 1.5h-8.5A.75.75 0 0 1 5 8M3.75 8a1.25 1.25 0 1 1-2.5 0a1.25 1.25 0 0 1 2.5 0M2.5 13.5a1.25 1.25 0 1 0 0-2.5a1.25 1.25 0 0 0 0 2.5" clip-rule="evenodd"/></svg>
                        <p>Choisir une catégorie</p>
                    </div>
                    <div id="edit-carte-content" className="rounded-t-xl bg-[#f6f3f0] w-full">
