export default function PlatItem({id, index, name, description, prix, traduisible, image, labels, onRemovePlat }) {
    return (
        <div data-id={id} data-index={index} data-type="plat" class="flex items-start px-4 py-3 cursor-pointer drag-item">
