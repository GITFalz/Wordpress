...
function dv_get_devis_page($post_id) {
...
// short code function to display the devis page
function dv_render_devis_page_shortcode($atts) {
    ...
    try {
        return dv_get_devis_page($post_id);
    } catch (Exception $e) {
        return '<p>' . esc_html($e->getMessage()) . '</p>';
    }
}
add_shortcode('df_devis_page', 'dv_render_devis_page_shortcode');